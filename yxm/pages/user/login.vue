<template>
    <div class="full_screen" style="overflow:hidden;height:auto;background:#fff">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell" for="s11">
                        <div class="weui-cell__hd" style="color:#4cd964">
							...
							<i style="font-size: 24upx;" class="iconfont icon-wanchengzhijiao has-text-white"></i>
						</span>
                        </div>
                        <div class="weui-cell__bd">
                            <p style="font-size: 24upx;">同意用户协议</p>
                        </div>
        ...
        <div class="weui-form__opr-area" style="margin-bottom:220px">
            <a @click="verify_code()" class="weui-btn weui-btn_primary " href="javascript:" id="showTooltips">确定</a>
        </div>



        <div class="weui-form__tips-area" @click="onNav" :data-url="'/pages/user/register'">
            <p class="weui-form__tips">
                还没有账号? <span class="has-text-link padded-h">立刻注册</span>
            </p>
        </div>
